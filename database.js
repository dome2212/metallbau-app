...
if (process.env.DATABASE_URL) {
  ...
  // Lokale Entwicklung (SQLite) – wird nur hier benötigt, daher lazy require,
  // damit sqlite3 auf Render (wo DATABASE_URL gesetzt ist) gar nicht erst
  // installiert/geladen werden muss.
