...
- 📸 Abschlussfotos mit optionaler **Beschriftung** (nachträglich bearbeitbar)
- 📋 **Statusverlauf** – wer hat wann den Status geändert (Timeline)
- 🏗️ **Materialentnahme** – direkt aus dem Projekt ins Lager buchen, Bestand wird automatisch abgezogen
...
| `/projects/:id/edit` | POST | Admin | Auftrag bearbeiten (loggt Statusänderung) |
| `/projects/:id/photos/upload` | POST | Alle | Baustellenfoto hochladen (mit optionaler Beschriftung) |
| `/projects/photos/caption` | POST | Alle | Foto-Beschriftung nachträglich setzen |
| `/projects/:id/material/add` | POST | Alle | Materialentnahme aus Lager buchen |
| `/projects/:id/pdf` | GET | Admin | Lieferschein-PDF |
| `/projects/:id/create-invoice` | GET/POST | Admin | Rechnung aus Auftrag erstellen |
| `/projects/update-status` | POST | Admin | Schnellstatus (loggt Statusänderung) |
